...
| `complex`    | complex numbers: `complex`/`creal`/`cimag`/`cabs`/`carg`/`conj` and `cadd`/`csub`/`cmul`/`cdiv`, with real-argument promotion |
| `cxmatrix`   | complex numbers as array/matrix elements: build/index/print round-trip, `rotate`/`transpose`/`ctranspose`/`submatrix`, complex `det`/`inverse`/`solve`/`matmul` |
